...
<nav class="navbar">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.html">Teacher - Nabarun Bidyaniketon</a>
        </div>
    ...
    <aside id="leftsidebar" class="sidebar">
        ...
        <div class="user-info">
            ...
            <div class="info-container">
                <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Teacher Name
                </div>
                ...
                <li>
                    ...
                    <ul class="ml-menu">
                        ...
                        <li>
                            ...
                            <ul class="ml-menu">
                                <li><a href="../gallery/index.php">Picture</a></li>

            ...
            <aside id="leftsidebar" class="sidebar">
                ...
                <div class="user-info">
                    ...
                    <div class="info-container">
                        <div class="name" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Nabarun
                            Biddyaniketon</div>
                        ...
                        <div class="btn-group user-helper-dropdown">
                            ...
                            <ul class="dropdown-menu pull-right">
                                ...
                                <li><a href="{{ url('/admin/editProfile') }}"><i class="material-icons">edit</i>Edit
                                        Profile</a></li>
                                <!-- <li><a href="../profile/index.php"><i class="material-icons">track_changes</i>Change Password</a></li> -->
                                <!-- <li><a href="javascript:void(0);"><i class="material-icons">favorite</i>Likes</a></li> -->
                                <li role="separator" class="divider"></li>
                                <li><a href="{{ url('/admin/admin-logout') }}"><i class="material-icons">input</i>Sign
                                        Out</a></li>
                            </ul>
                        </div>
                    </div>

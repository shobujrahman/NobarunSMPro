...
<head>
    ...
    <link href="{{ url('admin_assets/plugins/bootstrap-material-datetimepicker/css/bootstrap-material-datetimepicker.css') }}" rel="stylesheet" />
    ...
    <!-- Colorpicker Css -->
    <link href="{{ url('admin_assets/plugins/bootstrap-colorpicker/css/bootstrap-colorpicker.css') }}" rel="stylesheet" />
    ...
    <link href="{{ url('admin_assets/plugins/jquery-datatable/skin/bootstrap/css/dataTables.bootstrap.css') }}" rel="stylesheet">
                ...
                <div class="info-container">
                    ...
                    <div class="btn-group user-helper-dropdown">
                        ...
                        <ul class="dropdown-menu pull-right">
                            ...
                            <li><a href="{{ ('/admin/editprofile') }}"><i class="material-icons">edit</i>Edit Profile</a></li>
                            <!-- <li><a href="../profile/index.php"><i class="material-icons">track_changes</i>Change Password</a></li> -->
                            <!-- <li><a href="javascript:void(0);"><i class="material-icons">favorite</i>Likes</a></li> -->
                            <li role="separator" class="divider"></li>
                            <li><a href="{{ ('/admin/login') }}"><i class="material-icons">input</i>Sign Out</a></li>
                        </ul>
                    </div>
                </div>
            </div>
...
<script src="{{ url('admin_assets/plugins/bootstrap-material-datetimepicker/js/bootstrap-material-datetimepicker.js') }}">
</script>
...
<script src="{{ url('admin_assets/plugins/jquery-datatable/extensions/export/dataTables.buttons.min.js') }}"></script>

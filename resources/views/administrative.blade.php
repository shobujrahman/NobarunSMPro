            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 col-xs-6">
                    ...
                    <div class="team-member pDark">
                        ...
                        <div class="member-img">
                            <!-- Image  -->
                            <img class="img-responsive" src="user_assets/images/photo-2.jpg" alt="">
                        </div>
                        <!-- Member Details -->
                        <h4>Larry Doe</h4>
                        <!-- Designation -->
                ...
                <div class="col-md-3 col-sm-6 col-xs-6">
                    ...
                    <div class="team-member pDark">
                        ...
                        <div class="member-img">
                            <!-- Image  -->
                            <img class="img-responsive" src="user_assets/images/photo-3.jpg" alt="">
                        </div>
                        <!-- Member Details -->
                        <h4>Ranith Kays</h4>
                        <!-- Designation -->
                ...
                <div class="col-md-3 col-sm-6 col-xs-6">
                    ...
                    <div class="team-member pDark">
                        ...
                        <div class="member-img">
                            <!-- Image  -->
                            <img class="img-responsive" src="user_assets/images/photo-4.jpg" alt="">
                        </div>
                        <!-- Member Details -->
                        <h4>Joan Ray</h4>
                        <!-- Designation -->

                ...
                <div class="card">
                    <div class="header">
                        ...
                        <ul class="header-dropdown m-r--6">
                            <a href="../studentaccess/add.php" type="button" title="Add New"
                            ...
                            <table class="table table-bordered table-striped table-hover dataTable js-exportable">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="../studentaccess/edit.php" type="button" title="Edit"
                                                class="btn btn-warning btn-circle waves-effect waves-circle waves-float">
                                                <i class="material-icons">mode_edit</i>
                                            </a>
                                            <a href="../studentaccess/studentviewprofile.php" type="button"
                                                title="View Profile"

                    ...
                    <div class="card">
                        ...
                        <div class="row clearfix">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-line">
                                    <label >Address</label>
                                    <input type="text" class="form-control" placeholder="Collage Road" />
                                    </div>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-line">
                                    <label >Contact</label>
                                    <input type="number" class="form-control" placeholder="0174.**.0*" />
                                    </div>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    ...
                                    <div class="form-line">
                                    <label >E-mail</label>
                                    <input type="email" class="form-control" placeholder="member@gmail.com" />
                                    </div>
                                    </div>
                                </div>
                                <div class="col-sm-4">

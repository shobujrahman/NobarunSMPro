    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    <div class="header">
                        <h2>Edit Details View</h2>
                    </div>

                    <div class="body">
                        <form action="{{url('/admin/gallery/'.$gallery->id.'/details_update/'.$gallery_details->id)}}"
                            id="frmFileUpload" class="" method="post" enctype="multipart/form-data">@csrf
                            <input type="hidden" name="old_image" value="{{$gallery_details->image}}">
                            <div class="row clearfix">
                                <div class="col-sm-6">

                    ...
                    <div class="card profile-card">
                        ...
                        <div class="profile-body">
                            <div class="image-area">
                                <img src="../../admin_assets/images/user-lg.jpg" alt="AdminBSB - Profile Image"  height="128"
    width= "128"/>
                            </div>
                        ...
                        <div class="profile-footer">
                            ...
                            <li>
                                    <span>Access Id: </span>
                                    <span>2006370011</span>
                                </li>
                                <li>
                                    <span>Access Password: </span>
                                    <span>Student@7578</span>
                                </li>
                                <li>
                                    <span>Addmission Date: </span>
                                    <span>02/15/2010</span>
                                </li>
                                <li>
                                    <span>Contact: </span>
                                ...
                                <li>
                                    <span>E-mail: </span>
                                    <span>nbnstudent@email.com</span>
                                </li>
                                <li>
                                    <span>Address: </span>
                    ...
                    <!-- <div class="card card-about-me">
                        ...
                        <div class="body">
                            <ul>
                                ...
                                <h5>University of Tennessee at Knoxville</h5>
                                <h6>2018</h6>
                                <h4>H.S.C. in Science</h4>
                                <h5>Govt. Collage</h5>
                                <h6>2012</h6>
                                <h4>S.S.C. in Science</h4>
                                ...
                                <li>
                                    ...
                                    <div class="content">
                                    <ul>
                                    <li>1. Suspendisse tincidunt urna ut velit ullamcorper fermentum.</li>
                                    <li>2. Nullam mattis sodales lacus, in gravida sem auctor at.</li>
                                    <li>3. Praesent non lacinia mi.</li>
                                    <li>4. Mauris a ante neque.</li>
                                    <li>5. Aenean ut magna lobortis nunc feugiat sagittis.</li>
                                </ul>
                                    </div>
                                </li>
                                ...
                                <div class="tab-content">
                                    ...
                                    <div role="tabpanel" class="tab-pane fade in active" id="profile_settings">
                                        ...
                                        <div class="form-group">
                                                ...
                                                <label for="Accessname" class="col-sm-2 control-label">Access Id</label>
                                                <div class="col-sm-4">
                                                    <div class="form-line">
                                                        <input type="text" class="form-control" id="Accessid" name="Accessname" placeholder="Access Id" value="2006370011" required disabled>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-line">
                                                        <input type="text" class="form-control" id="Firstname" name="Firstname" placeholder="First Nname" value="Nitto" required disabled>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-line">
                                                        <input type="text" class="form-control" id="Lastname" name="Lastname" placeholder="Last Nname" value="Nitai" required disabled>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-3">
                                                    <div class="form-line">
                                                        <input type="text" class="form-control" id="Designation" name="Designation" placeholder="Designation" value="Student" required disabled>
                                                    </div>
                                                </div>
